...
const config = {
    Owner: '📱MIQDADMODS BOT📱',
    instagram: 'https://instagram.com/thelfd.06',
    nomer: 'wa.me/6285326364468',
    aktif: '24 JAM',
    youtube: 'https://youtube.com/channel/UCa0h-GwjdTQR99K8DwzjANw',
    whatsapp: 'https://chat.whatsapp.com/G1KZeeHYZ6vEPVr8XhicDc',
   ...
   switch (prefix) {
      ...
      case 'info':
       ...
       case 'nulis':
           nulis(value)
               .then(data => {
                   client.sendMessage(id, '[❗] PLEASE WAIT [❗]', MessageType.text)
